...
## 从结构开始分析
![Pasted image 20260522170451.png](/assets/Pasted%20image%2020260522170451.png)
...
![Pasted image 20260522195833.png](/assets/Pasted%20image%2020260522195833.png)上面这一张图就是缩放点积注意力的示意图。对于注意力机制来说，以往得到认同的注意力计算的思路是：
...
![Pasted image 20260522204307.png](/assets/Pasted%20image%2020260522204307.png)
...
![Pasted image 20260524160110.png](/assets/Pasted%20image%2020260524160110.png)
这样一个矩阵就是我们提供给Transformer的原始输入。在不考虑多头的情况下，这个输入会分别与三个系数矩阵相乘，得到运算结果QKV三个矩阵。这里的矩阵相乘在网络中对应三个线性层。

![Pasted image 20260524161417.png](/assets/Pasted%20image%2020260524161417.png)
...
![Pasted image 20260524162831.png](/assets/Pasted%20image%2020260524162831.png)
